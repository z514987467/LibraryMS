...
<table width="756" height="77" border="0" align="right" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="85" align="right" class="daohang1"><asp:HyperLink ID="hpLinkAddRType" runat="server" NavigateUrl="~/ReaderManage/AddRType.aspx" Width="102px" ForeColor="Black">添加读者类型信息</asp:HyperLink></td>
                  <td width="45">&nbsp;</td>
                </tr>
              </table></td>
            </tr>
