            ...
            <tr>
              <td height="22" background="../images/tu shu pai hang2.gif"><table width="756" height="77" border="0" align="right" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="89" align="right" class="daohang1"><asp:HyperLink ID="hpLinkAddReader" runat="server" NavigateUrl="~/ReaderManage/AddReader.aspx" ForeColor="Black">添加读者信息</asp:HyperLink></td>
                  <td width="45">&nbsp;</td>
                </tr>
              </table></td>
            </tr>
