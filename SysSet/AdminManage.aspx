        ...
        <tr>
            <td valign="top">
                <table width="756" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <table width="756" height="77" border="0" align="right" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td width="89" align="right" class="daohang1">
                                        <asp:HyperLink ID="hpLinkAddAdmin" runat="server" NavigateUrl="~/SysSet/AddAdmin.aspx" ForeColor="Black">添加管理员</asp:HyperLink></td>
                                    <td width="45">&nbsp;</td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td height="23" background="../images/tu shu pai hang2.gif" style="text-align: center">
                            <asp:GridView ID="gvAdminPurview" runat="server" AllowPaging="True" CellPadding="4"
                                ForeColor="#333333" PageSize="5" AutoGenerateColumns="False" Font-Size="9pt" Style="margin: 0 auto"
                                OnPageIndexChanging="gvAdminPurview_PageIndexChanging" OnRowCancelingEdit="gvAdminPurview_RowCancelingEdit"
                                OnRowDeleting="gvAdminPurview_RowDeleting" OnRowEditing="gvAdminPurview_RowEditing" OnRowUpdating="gvAdminPurview_RowUpdating" Width="543px">
